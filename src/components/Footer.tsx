...
const Footer = ({
  socialLinks = {
    twitter: "https://twitter.com/stormsense_app",
  ...
  return (
    <footer className="bg-slate-900 text-white py-8 px-4 md:px-8 w-full">
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          {/* Right Side - Download Buttons, Social Media and Copyright */}
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
            {/* Download Buttons */}
            ...
            <div className="text-sm text-slate-400">
              &copy; {copyrightYear} StormSense. All rights reserved.
            </div>
          </div>
        </div>
      </div>
